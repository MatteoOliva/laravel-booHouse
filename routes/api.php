...
Route::get('apartments/search/ordered/{search_term}/{lat}/{lon}/{radius}/{rooms}/{beds}/{toilets}/{mq}', [ApiController::class, 'search_ordered'])->name('api.apartments.search.ordered');
