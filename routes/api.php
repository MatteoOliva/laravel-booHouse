...
Route::get('apartments/search/ordered/{lat}/{lon}/{radius}', [ApiController::class, 'search_ordered'])->name('api.apartments.search.ordered');
Route::get('apartments/search/not_sponsored/{search_term}', [ApiController::class, 'not_sponsored_search'])->name('api.apartments.searc.not_sponsored'); // riceve termine di ricerca e restituisce appartamenti non sponsorizzati
